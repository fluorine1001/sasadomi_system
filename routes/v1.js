...
export default function v1Router(db, admin) {
     ...
     * rewardList:
     * type: array
     * description: 학생에게 부여된 상점 상세 내역 목록
     * items:
     * type: object
     * properties:
     ...
     * penaltyList:
     * type: array
     * description: 학생에게 부여된 벌점 상세 내역 목록
     * items:
     * type: object
     * properties:
     ...
     * teacher: { type: string, example: "홍주환", description: "/v1/meta/options의 teachers 목록에 존재하는 지도교사 이름 (라벨)" }
     ...
     * place: { type: string, description: "반드시 /v1/meta/options에서 조회한 studyPlaces의 value 값을 사용해야 합니다 (예: 1~11)", example: "4" }
